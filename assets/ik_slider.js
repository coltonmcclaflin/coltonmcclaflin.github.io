;(function ( $, window, document, undefined ) {
	...
	var pluginName = 'ik_slider',
		defaults = {
            'instructions': 'Use the right and left arrow keys to increase or decrease the slider value. Home and End keys to set values to minumum and maximum values correspondingly.',
			'minValue': 0,
			'maxValue': 100,
			'nowValue': 0,
			'step': 1
